...
import { validateBody, notificationTypeSettingsSchema } from "@/lib/api-validation";
...
export async function PUT(
  ...
  try {
    ...
    const validationError = validateBody(notificationTypeSettingsSchema, body);
    if (validationError) {
